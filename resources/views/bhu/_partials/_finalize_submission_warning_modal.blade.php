<div class="modal fade" tabindex="-1" role="dialog" id="finalizeResultModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-danger">Are You SURE You Want To PROCEED? Doing So Will Make Your Changes FINAL!</p>
            </div>
